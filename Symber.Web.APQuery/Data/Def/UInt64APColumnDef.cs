...
namespace Symber.Web.Data
{
	...
	/// <summary>
	/// UInt64 column definition.
	/// </summary>
	[Serializable]
	public class UInt64APColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new UInt64 column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public UInt64APColumnDef(string tableName, string columnName)
		...
		public UInt64APColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public UInt64APColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public UInt64APColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(UInt64APColumnDef column, UInt64 value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(UInt64 value, UInt64APColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params UInt64[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params UInt64[] value)
		{
		...
		public APSqlConditionPhrase Between(UInt64 begin, UInt64 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new UInt64[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(UInt64 begin, UInt64 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new UInt64[2] { begin, end });
		}
