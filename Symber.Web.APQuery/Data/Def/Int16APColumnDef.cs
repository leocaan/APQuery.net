...
namespace Symber.Web.Data
{
	...
	/// <summary>
	/// Int16 column definition.
	/// </summary>
	[Serializable]
	public class Int16APColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new int16 column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public Int16APColumnDef(string tableName, string columnName)
		...
		public Int16APColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public Int16APColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public Int16APColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(Int16APColumnDef column, Int16 value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(Int16 value, Int16APColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params Int16[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params Int16[] value)
		{
		...
		public APSqlConditionPhrase Between(Int16 begin, Int16 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new Int16[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(Int16 begin, Int16 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new Int16[2] { begin, end });
		}
