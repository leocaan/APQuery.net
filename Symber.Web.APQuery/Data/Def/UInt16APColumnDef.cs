...
namespace Symber.Web.Data
{
	...
	/// <summary>
	/// UInt16 column definition.
	/// </summary>
	[Serializable]
	public class UInt16APColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new UInt16 column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public UInt16APColumnDef(string tableName, string columnName)
		...
		public UInt16APColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public UInt16APColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public UInt16APColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(UInt16APColumnDef column, UInt16 value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(UInt16 value, UInt16APColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params UInt16[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params UInt16[] value)
		{
		...
		public APSqlConditionPhrase Between(UInt16 begin, UInt16 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new UInt16[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(UInt16 begin, UInt16 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new UInt16[2] { begin, end });
		}
