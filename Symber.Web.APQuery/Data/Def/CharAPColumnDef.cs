...
namespace Symber.Web.Data
{
	...
	/// </summary>
	[Serializable]
	public class CharAPColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new char column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public CharAPColumnDef(string tableName, string columnName)
		...
		public CharAPColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public CharAPColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public CharAPColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(CharAPColumnDef column, Char value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(Char value, CharAPColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params Char[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params Char[] value)
		{
		...
		public APSqlConditionPhrase Between(Char begin, Char end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new Char[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(Char begin, Char end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new Char[2] { begin, end });
		}
