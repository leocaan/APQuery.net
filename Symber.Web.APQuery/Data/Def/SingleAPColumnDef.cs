...
namespace Symber.Web.Data
{
	...
	/// </summary>
	[Serializable]
	public class SingleAPColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new single column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public SingleAPColumnDef(string tableName, string columnName)
		...
		public SingleAPColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public SingleAPColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public SingleAPColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(SingleAPColumnDef column, Single value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(Single value, SingleAPColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params Single[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params Single[] value)
		{
		...
		public APSqlConditionPhrase Between(Single begin, Single end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new Single[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(Single begin, Single end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new Single[2] { begin, end });
		}
