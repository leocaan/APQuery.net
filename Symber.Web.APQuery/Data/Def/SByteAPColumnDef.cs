...
namespace Symber.Web.Data
{
	...
	/// <summary>
	/// SByte column definition.
	/// </summary>
	[Serializable]
	public class SByteAPColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new sbyte column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public SByteAPColumnDef(string tableName, string columnName)
		...
		public SByteAPColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public SByteAPColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public SByteAPColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(SByteAPColumnDef column, SByte value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(SByte value, SByteAPColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params SByte[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params SByte[] value)
		{
		...
		public APSqlConditionPhrase Between(SByte begin, SByte end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new SByte[2] { begin, end });
		}
		...
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new SByte[2] { begin, end });
		}
