...
namespace Symber.Web.Data
{
	...
	/// </summary>
	[Serializable]
	public class ByteAPColumnDef : APColumnDef
	{
		...
		public ByteAPColumnDef(string tableName, string columnName)
		...
		public ByteAPColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public ByteAPColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public ByteAPColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(ByteAPColumnDef column, Byte value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(Byte value, ByteAPColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params Byte[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params Byte[] value)
		{
		...
		public APSqlConditionPhrase Between(Byte begin, Byte end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new Byte[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(Byte begin, Byte end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new Byte[2] { begin, end });
		}
