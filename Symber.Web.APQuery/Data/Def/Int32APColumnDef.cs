...
namespace Symber.Web.Data
{
	...
	/// <summary>
	/// Int32 column definition.
	/// </summary>
	[Serializable]
	public class Int32APColumnDef : APColumnDef
	{
		...
		/// <summary>
		/// Create a new int32 column definition.
		/// </summary>
		/// <param name="tableName">Table name.</param>
		/// <param name="columnName">Column name in database.</param>
		public Int32APColumnDef(string tableName, string columnName)
		...
		public Int32APColumnDef(string tableName, string columnName, bool isNullable)
		...
		/// <param name="columnName">Column name in database.</param>
		public Int32APColumnDef(APTableDef tableDef, string columnName)
		...
		/// <param name="columnName">Column name in database.</param>
		/// <param name="isNullable">Is nullable.</param>
		public Int32APColumnDef(APTableDef tableDef, string columnName, bool isNullable)
		...
		public static APSqlConditionPhrase operator ==(Int32APColumnDef column, Int32 value)
		{
		...
		/// <param name="column">Column definition.</param>
		/// <returns>Condition phrase of '=='.</returns>
		public static APSqlConditionPhrase operator ==(Int32 value, Int32APColumnDef column)
		{
			return new APSqlConditionPhrase(column, APSqlConditionOperator.Equals, value);
		}
		...
		public APSqlConditionPhrase In(params Int32[] value)
		{
		...
		public APSqlConditionPhrase NotIn(params Int32[] value)
		{
		...
		public APSqlConditionPhrase Between(Int32 begin, Int32 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.Between, new Int32[2] { begin, end });
		}
		...
		public APSqlConditionPhrase NotBetween(Int32 begin, Int32 end)
		{
			return new APSqlConditionPhrase(this, APSqlConditionOperator.NotBetween, new Int32[2] { begin, end });
		}
